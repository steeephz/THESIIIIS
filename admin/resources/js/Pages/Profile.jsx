...
const Profile = () => {
    ...
    return (
        <div className="min-h-screen bg-[#60B5FF] font-[Poppins]">
            {/* Sidebar */}
            <div className="fixed left-0 top-0 h-full w-[240px] bg-white shadow-lg transform transition-transform duration-200 lg:translate-x-0 md:translate-x-0 sm:translate-x-0 xs:-translate-x-full">
                <div className="p-4">
                ...
                <nav className="mt-8">
                    ...
                    <Link href="/admin/profile" className={`flex items-center px-6 py-3 text-base text-blue-600 bg-blue-50 ${window.location.pathname === '/admin/profile' ? 'text-blue-600 bg-blue-50' : ''}`}> 
